...
public class PathFollowerScript : MonoBehaviour
{
    ...
    public void MoveTo(GridNode target)
    {
    ...
    private void RecalculatePath()
    {
        ...
        // Convert GridNodes to Grid indices
        ...
        if (path != null && path.Count > 0)
        {
            ...
            {
                GridNode node = gridGenerator.nodes[nodePos.x, nodePos.y];
                if (node != null)
...
//         // Convert path indices to GridNode queue
//         pathQueue.Clear();
//         if (path != null && path.Count > 0)
//         {
//             foreach (Vector2Int nodePos in path)
